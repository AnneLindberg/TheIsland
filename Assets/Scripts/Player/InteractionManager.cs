...
public class InteractionManager : MonoBehaviour
{
    ...
    private Camera cam; //creating variable because just calling Camera.Main is bad for preformance
    ...
    // not working right now.. when it hover it just uses the text written in the InteractPromtText
    void SetPromptText()
    {
